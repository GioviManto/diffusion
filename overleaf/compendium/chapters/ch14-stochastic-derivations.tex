...
trajectory follows from \eqref{eq:chain-factorisation-long}. Throughout the
...
Chapter~\ref{ch:graphical} makes systematic.
...
(Chapter~\ref{ch:diffusion-long}), and why so much of this thesis is devoted
