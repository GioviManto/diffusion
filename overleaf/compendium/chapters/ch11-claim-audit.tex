...
applied to the one statistic that needed more. The fitted innovation \emph{shape} needs on
the order of $2000$ iterations to settle while $\corr$ is flat from about iteration $25$, and
the generative metric is a shape statistic. So the comparison scored converged estimators
