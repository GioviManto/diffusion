...
$\halfwidth$ & $4$ & $6$ & $8$ & $10$ \\
\midrule
worst chain & $2.3\times10^{-3}$ & $1.6\times10^{-4}$ & $1.2\times10^{-6}$
            & $3.3\times10^{-8}$ \\
$90$th percentile & $2.7\times10^{-4}$ & $2.5\times10^{-6}$ & $1.5\times10^{-8}$
                  & $7.8\times10^{-11}$ \\
median & $3.8\times10^{-5}$ & $3.8\times10^{-7}$ & $3.0\times10^{-9}$
       & $1.8\times10^{-11}$ \\
\bottomrule
\end{tabular}
\end{center}
