...
\label{ch:diffusion-long}\label{ch:ebm}
...
\begin{enumerate}
  ...
  Chapter~\ref{ch:graphical} and executed in Chapter~\ref{ch:gaussian}.
\end{enumerate}
...
(Chapter~\ref{ch:probability}); Chapter~\ref{ch:gaussian} quantifies
...
Chapters~\ref{ch:gaussian} and~\ref{ch:numerics}, with the inference tools
prepared in Chapter~\ref{ch:graphical} and the path that led to the precise
formulation recorded in Chapter~\ref{ch:probability}.
