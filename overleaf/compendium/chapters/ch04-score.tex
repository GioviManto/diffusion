...
classical in empirical Bayes, due to \citet{robbins1956} and \citet{miyasawa1961}, and is
usually called Tweedie's formula after the exposition in \citet{efron2011}. Its use as a
training objective for generative models is \citet{vincent2011}, building on the score-matching
estimator of \citet{hyvarinen2005}; the generative-modelling application is \citet{song2019}.
