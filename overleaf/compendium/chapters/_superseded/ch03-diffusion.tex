...
convention used throughout \citep{song2021}, it is the stochastic differential equation
\begin{equation}
\label{eq:ou}
...
are from \citet{song2021}; the discrete-time antecedents are \citet{sohl2015} and
\citet{ho2020}. The time-reversal theorem that supplies the reverse drift is
\citet{anderson1982}, with the general treatment in \citet{haussmann1986}. The Fokker--Planck
machinery underlying both is standard \citep{risken1989}. Choices of $\tmin$, $\tmax$ and the
time discretisation are discussed empirically by \citet{karras2022}.
