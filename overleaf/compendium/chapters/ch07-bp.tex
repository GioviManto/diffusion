...
\citep{baum1970}, of which \citet{rabiner1989tutorial} is the standard exposition. In the
linear-Gaussian case they specialise to the Kalman filter \citep{kalman1960new} and the
Rauch--Tung--Striebel smoother \citep{rauch1965maximum}. \citet{cappe2005} treats the continuous-state
case in the generality needed here. That U-Net architectures can be read as approximate belief
propagation on a hierarchical model is argued by \citet{mei2024unets}.
