...
convergence rate, where the theory places it. The endpoints show that this is a
cost in rate and not in where the fit lands: the clean and channel arms finish
within $0.002$ of each other on the correlation and within a fifth of a unit on
excess kurtosis, both close to the generating values.
...
Chapter~\ref{ch:em-results} used as a default, before this measurement existed,
