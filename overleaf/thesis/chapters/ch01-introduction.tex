...
establishing anything about the model itself. Every claim is either proved by
...
\paragraph{The status of a result, in four kinds.} ``Exact'' is used for
...
\begin{description}
  ...
  grid after a stated discretisation --- BP on the resulting finite-state
  chain, for instance, is exact up to floating point. This does \emph{not}
  claim the discretisation reproduces the continuum answer; that is the next
  category.
...
derivations, and the robustness of the headline aggregation.
