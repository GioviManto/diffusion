...
\begin{enumerate}
  ...
  relative score error is $0.24$ at $t = 0.05$, falls below $10^{-2}$ by
  $t \approx 1$ and below $10^{-3}$ by $t \approx 2.1$, with the score
  direction substantially more accurate than its magnitude, in the tested
  regimes (Chapter~\ref{ch:laplace}).
