...
Appendix~\ref{app:diffusion-deriv}: by the Hammersley--Clifford theorem
...
reproduce the message-passing schedule --- the network discovers the
inference algorithm rather than approximating the function some other
way. Read together with \citet{mei2024unets}, the claim is
architecture-independent: what a denoiser must implement is determined by
the graphical structure of the data, and the natural depth is set by that
structure. This is precisely why the chain matters here. A chain is a
