...
The Hammersley--Clifford theorem connects conditional independence to an
energy representation \citep[proved in][]{besag1974spatial}: for a strictly
positive density, the Markov property with respect to $G$ is equivalent to
factorisation over the \emph{cliques} of $G$,
\begin{equation}
...
energies are one and the same thing. The Ising model is the textbook
example. The decisive example for us is one-dimensional:
