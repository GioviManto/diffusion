...
\begin{enumerate}
  ...
  not remove it.
  \item \textbf{The potential experiment is incomplete.} The $(\lambda,r_*)$
  sweep runs 300 gradient steps per cell and had not finished at the time of
  writing. Its preliminary reading --- that both arms recover the well, which
  is the expected contrast with the rotation --- is stated as preliminary and
