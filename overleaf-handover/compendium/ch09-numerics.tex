...
be quoted. It is now recorded (\codefile{outputs/exp\_18/boundary.csv},
\codefile{experiments/exp\_18\_revision\_diagnostics.py}). Taking the worst case over all $32$
sites of a forward sweep on a Laplace chain at $\corr=0.85$:
...
$\halfwidth$ & $4$ & $6$ & $8$ & $10$ \\
\midrule
worst boundary mass & $3.4\times10^{-4}$ & $2.0\times10^{-6}$ & $1.4\times10^{-8}$
                    & $1.4\times10^{-10}$ \\
\bottomrule
\end{tabular}
\end{center}
...
is eight orders of magnitude below any effect this project reports.
