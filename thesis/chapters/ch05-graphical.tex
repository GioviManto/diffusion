...
on hierarchical models. Nothing here is original; everything here is
used.
...
The dual reading of zeros is the structural fact this thesis lives on. A
...
matrix one should look at depends on the question, and confusing the two
is the most common error in reasoning about Gaussian dependence.
...
once and for all by the $U$ of $A$. This is the fact that will
diagonalise the entire diffusion lifecycle of
Chapter~\ref{ch:gaussian} in one stroke. Third, for the symmetric
...
disjoint components. Trees are the tractable island of inference: on
