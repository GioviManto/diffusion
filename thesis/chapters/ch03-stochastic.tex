...
discrete and in continuous time, and it earns its place in the thesis
three times over. Markov chains are the \emph{data} whose diffusion score
...
Sections~\ref{sec:fokker-planck}--\ref{sec:reversal} are the mathematical
licence for the entire generative programme reviewed in
Chapter~\ref{ch:diffusion}. Standard references are
