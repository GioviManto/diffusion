...
Factor graphs and the sum-product algorithm in the form used here are \citet{kschischang2001};
...
\citet{mezard2009}; for the exponential-family and variational view, \citet{wainwright2008}.
