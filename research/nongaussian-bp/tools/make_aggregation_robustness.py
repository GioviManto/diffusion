...
# That ordering is an empirical property of these cells, NOT a theorem: the
# appendix used to attribute it to Jensen, but E[X/Y] >= E[X]/E[Y] does not hold
# for arbitrary correlated positive X and Y. Disclosing the ordering is the
# whole value here; explaining it by a law that does not apply was worse than
