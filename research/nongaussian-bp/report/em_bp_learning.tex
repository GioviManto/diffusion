...
per E-step --- generalized EM, which only requires $Q$ to increase. The gradient
is where the structure pays off. By the chain rule applied to
\eqref{eq:Q-bilinear},
\begin{equation}
...
\item \textbf{Objective} is denoising score matching, whose minimizer is exactly
  ...
  handicapped by a surrogate loss.
