...
Score-based diffusion for dynamic objects: exact joint scores for Markov chains,
Gaussian belief propagation, AMP, and Gaussian-closure error beyond the Gaussian case.
...
Full project history (superseded packages, toy models, transcripts) is preserved
outside this repo in `../archive/`.
